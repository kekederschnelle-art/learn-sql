...
insert into anfragen (kunde_id, fahrzeug_id, gestellt_am, status) values
  ...
  -- Datumsbedingung auf 'abgelehnt' ueberhaupt etwas bewirkt.
  (7, 15, '2025-04-18', 'abgelehnt');
`,
  },
...
-- Absicht: zwei Kunden ohne jede Anfrage, damit LEFT JOIN auf anfragen
...
create table fahrzeuge_archiv (
  ...
  farbe       text not null,
  getriebe    text not null,
  verkauft_am date not null
);

insert into fahrzeuge_archiv (marke, modell, baujahr, km_stand, preis, farbe, getriebe, verkauft_am) values
  ('Volkswagen', 'Tiguan II',    2018, 112000, 19400.00, 'grau',    'automatik', '2024-11-08'),
  ('Volkswagen', 'Up! I',        2017,  64300,  7900.00, 'weiss',   'manuell',   '2025-01-22'),
  ('BMW',        'X1 F48',       2019,  87600, 23800.00, 'schwarz', 'automatik', '2024-12-14'),
  ('Mercedes',   'B 200 W247',   2020,  51200, 22400.00, 'silber',  'automatik', '2025-02-05'),
  ('Audi',       'A1 GB',        2019,  43900, 16200.00, 'rot',     'manuell',   '2025-03-17'),
  ('Audi',       'A6 C8',        2018, 158300, 24600.00, 'schwarz', 'automatik', '2025-04-29'),
  ('Skoda',      'Superb III',   2017, 176500, 12800.00, 'blau',    'automatik', '2024-10-30'),
  ('Ford',       'Kuga III',     2020,  69800, 20100.00, 'grau',    'manuell',   '2025-05-12'),
  ('Renault',    'Clio V',       2021,  35400, 14700.00, 'weiss',   'manuell',   '2025-06-03'),
  ('Peugeot',    '208 II',       2020,  48100, 13600.00, 'blau',    'manuell',   '2025-06-25');
`,
  },

  {
    level: 8,
    label: 'merkliste (leer)',
